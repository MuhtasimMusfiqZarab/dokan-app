	...
	return (
		<View style={styles.container}>
			<TouchableOpacity
				...
				<Image source={Images.CategoryColorIcon} style={styles.btnIconImage} />
				<Text style={{ color: Color.wdDeepGray }}>Categories</Text>
			</TouchableOpacity>
			<TouchableOpacity
				onPress={() => onPressVendors(props)}
				style={styles.atAglanceBtn}>
				<Image source={Images.VendorColorIcon} style={styles.btnIconImage} />
				<Text style={{ color: Color.wdDeepGray }}>Vendors</Text>
			</TouchableOpacity>
			<TouchableOpacity
				onPress={() => onPressProducts(props)}
				style={styles.atAglanceBtn}>
				<Image source={Images.ProductColorIcon} style={styles.btnIconImage} />
