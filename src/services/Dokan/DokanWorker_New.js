...
import DokanAPI from "./DokanAPI";

export default class DokanWorker {
  _api = null;
  ...
  static getFeaturedProducts = async () => {
    try {
      const response = await this._api.get("products/featured", {
        hide_empty: true,
        per_page: 100,
        order: "desc",
        orderby: "count",
  ...
  static getTopProducts = async () => {
    try {
        const response = await this._api.get("products/top_rated", {
          hide_empty: true,
          per_page: 100,
          order: "desc",
          orderby: "count",
  ...
  static getLatestProducts = async () => {
    try {
        const response = await this._api.get("products/latest", {
          hide_empty: true,
          per_page: 100,
          order: "desc",
          orderby: "count",
  ...
  static getBestSellingProducts = async () => {
    try {
        const response = await this._api.get("products/best_selling", {
          hide_empty: true,
          per_page: 100,
          order: "desc",
          orderby: "count",
  ...
  static getRelatedProducts = async(prodID) => {
    try {
        const response = await this._api.get(`products/${prodID}/best_selling`, {
          hide_empty: true,
          per_page: 100,
          order: "desc",
          orderby: "count",
  ...
  static getFeaturedVendors = async() => {
    try {
      const response = await this._api.get("stores?featured=yes", {
        hide_empty: true,
        per_page: 100,
        order: "desc",
        orderby: "count",
