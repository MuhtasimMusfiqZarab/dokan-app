/**
 * Created by weDevs on 11/11/2018.
 * 
 * @format
 */
...
function DokanAPI(opt) {
  if (!(this instanceof DokanAPI)) {
    return new DokanAPI(opt);
  }
...
DokanAPI.prototype._setDefaultsOptions = function(opt) {
  this.url = opt.url;
  this.wpAPI = opt.wpAPI || false;
  this.wpAPIPrefix = opt.wpAPIPrefix || "wp-json";
  this.version = opt.version || "dokan/v1";
...
DokanAPI.prototype._normalizeQueryString = function(url) {
...
DokanAPI.prototype._getUrl = function(endpoint) {
...
// DokanAPI.prototype._getOAuth = function() {
//   const data = {
//     consumer: {
...
DokanAPI.prototype.join = function(obj, separator) {
  const arr = [];
...
DokanAPI.prototype._request = async function(method, endpoint, newData) {
...
DokanAPI.prototype.get = async function(endpoint, data, callback) {
  return await this._request("GET", endpoint, data, callback);
};

DokanAPI.prototype.post = async function(endpoint, data, callback) {
  return await this._request("POST", endpoint, data, callback);
};

DokanAPI.prototype.put = async function(endpoint, data, callback) {
  return await this._request("PUT", endpoint, data, callback);
};

DokanAPI.prototype.delete = async function(endpoint, callback) {
  return await this._request("DELETE", endpoint, null, callback);
};

DokanAPI.prototype.options = async function(endpoint, callback) {
