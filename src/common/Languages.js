...
export default new LocalizedStrings({
	en: {
		...
		FinishOrder: 'Thank you for your purchase',
		NextStep: 'Next Step',
		...
		EnterYourAddress: 'House Number and Street Name',
		...
		// about us
		AppName: 'Dokan',
		AppDescription: 'Mobile app companion for Dokan Plugin',
		AppContact: ' Contact us at: wedevs.com',
		AppEmail: ' Email: info@wedevs.com',
		AppCopyRights: '© weDevs 2019',
		...
		TypeAddress1: 'House Number and Street Name',
		TypeAddress2: 'Apartment, suite, unite etc.',
		...
		TypeNote: 'Notes about your order, e.g. special notes for delivery.',
