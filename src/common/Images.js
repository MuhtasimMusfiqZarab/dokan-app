...
const Images = {
	...
	// splashScreen: require('@images/download.png'),
	...
	PopularCatImages: {
		...
		Computer: require('@images/categories/computer.png'),
		Dress: require('@images/categories/dress.png'),
	...
	NoConnection: require('@images/no_internet.png'),
};
